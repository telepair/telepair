...
/** Format an ISO timestamp using the browser's locale. We don't reach
 *  for `Intl.DateTimeFormat` with explicit options here because the
 *  default already produces a sensible "YYYY-MM-DD HH:MM:SS"-ish form
 *  in both en-US and zh-CN, which is what we want for an audit log. */
